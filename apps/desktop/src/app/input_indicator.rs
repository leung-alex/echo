...
fn tsf_json(value: Option<TsfDiagnostic>) -> serde_json::Value {
    value.map_or(serde_json::Value::Null, |trace| {
        serde_json::json!({
            ...
            "pending_high_water": trace.pending_high_water,
            "api_requests": trace.api_requests,
            "request_edit_calls": trace.request_edit_calls,
            ...
            "ready_results": trace.ready_results,
            "mock_sessions": trace.mock_sessions,
            "mock_callback_entered": trace.mock_callback_entered,
            "mock_callback_completed": trace.mock_callback_completed,
            "mock_final_released": trace.mock_final_released,
