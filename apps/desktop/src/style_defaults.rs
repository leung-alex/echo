...
pub(super) fn defaults() -> StyleSnapshot {
    StyleSnapshot(std::collections::BTreeMap::from([
        ...
        ("color.accent".into(), StyleValue::Color(0x36789bff, 0x79b9dcff)),
        ("color.accent-text".into(), StyleValue::Color(0x285f80ff, 0xa5d6f0ff)),
        ...
        ("color.focus".into(), StyleValue::Color(0x36789bff, 0x91ccebff)),
        ("color.line".into(), StyleValue::Color(0xe4e7e9ff, 0x35434eff)),
        ("color.muted".into(), StyleValue::Color(0x61788bff, 0xb2c4d1ff)),
        ...
        ("row.action-color".into(), StyleValue::Color(0x70757bff, 0xb7bdc5ff)),
